...
DROP DATABASE `ri-case-dev-mf`;
CREATE SCHEMA `ri-case-dev-mf` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
Intelij: 
- crt+shift+v - pokazuje schowek
- crt+u - pokazuje superclass albo interface
